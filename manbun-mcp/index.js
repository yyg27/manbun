#!/usr/bin/env node
// Manbun MCP server: serves the lazy-senior-dev ruleset over stdio as a
...
const server = new McpServer({ name: "manbun", version });

const modeArg = z
  .enum(MODES)
  .optional()
  .describe("Manbun intensity: lite, full, or ultra. Omit for the configured default.");
...
server.registerTool(
  "manbun_instructions",
  {
    title: "Manbun instructions",
    description: "Return the Manbun ruleset for the given intensity (lite, full, or ultra).",
