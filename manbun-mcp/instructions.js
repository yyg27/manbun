// Pure instruction selection for the Manbun MCP server. No MCP/SDK imports,
...
const { getManbunInstructions } = require("../hooks/manbun-instructions.js");
const { getDefaultMode, normalizeMode } = require("../hooks/manbun-config.js");
...
// manbun: keep the surface to these three; "off"/"review" aren't served here.
...
export function buildInstructions(requested) {
  return getManbunInstructions(resolveMode(requested));
}
