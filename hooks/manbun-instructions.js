#!/usr/bin/env node
// Shared Manbun instruction builder for Claude hooks and Pi extension.
...
function getFallbackInstructions(mode) {
  return 'MANBUN MODE ACTIVE — level: ' + mode + '\n\n' +
    ...
    '## Persistence\n\n' +
    'ACTIVE EVERY RESPONSE. No drift back to over-building. Still active if unsure. Off only: "stop manbun" / "normal mode".\n\n' +
    ...
    'Mark deliberate simplifications that cut a real corner with a known ceiling, using a `manbun:` comment that names the ceiling and upgrade path.\n\n' +
    '## Output\n\n' +
    ...
    '## Boundaries\n\n' +
    'Manbun governs what you build, not how you talk. "stop manbun" or "normal mode": revert. Level persists until changed or session end.';
}
