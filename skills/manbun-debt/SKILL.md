...
name: manbun-debt
description: >
  Harvest every `manbun:` comment in the codebase into a debt ledger, so the
  deliberate shortcuts and deferrals manbun leaves behind get tracked instead
  of rotting into "later means never". Use when the user says "manbun debt",
  "/manbun-debt", "what did manbun defer", "list the shortcuts", "manbun
