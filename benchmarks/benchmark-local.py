"""
Manbun local benchmark — runs the same 5 tasks against any Ollama model.
No promptfoo required. Compares baseline vs caveman vs manbun on code LOC
...
def load_arms():
    return {
        ...
        "manbun": (ROOT / "skills/manbun/SKILL.md").read_text(encoding="utf-8"),
    }
...
def main():
    parser = argparse.ArgumentParser(description="Manbun local benchmark via Ollama")
