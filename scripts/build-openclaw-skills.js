...
// format manbun already uses, with one difference: `description` must be a
...
const HOMEPAGE = 'https://github.com/yyg27/manbun';

const DESCRIPTIONS = {
  'manbun': 'Lazy senior dev mode for any coding task (write, refactor, fix, review): YAGNI, stdlib first, no unrequested abstractions. Not for non-coding requests.',
  'manbun-review': 'Review a diff for over-engineering. Finds what to delete: reinvented stdlib, needless deps, speculative abstractions. One line per finding.',
  'manbun-audit': 'Audit the whole repo for over-engineering. A ranked list of what to delete, simplify, or replace with stdlib or native features.',
  'manbun-debt': 'Harvest every manbun: shortcut comment into one debt ledger, so deferrals get tracked instead of forgotten. One-shot report.',
  'manbun-gain': 'Show manbun measured impact as a scoreboard: less code, less cost, more speed, from the benchmark medians. One-shot display.',
  'manbun-help': "Quick reference for manbun's modes, skills, and commands. One-shot display.",
};
